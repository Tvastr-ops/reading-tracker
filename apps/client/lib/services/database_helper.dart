  ...
  Future<void> _createDB(Database db, int version) async {
    ...
    final initialBooks = [
      Book(
        ...
        progress: 240,
        totalUnits: 388,
        genreTags: 'Fiction, Fantasy',
        coverUrl: 'https://covers.openlibrary.org/b/id/10313322-M.jpg',
        readingPace: 4.2,
      ...
      Book(
        ...
        totalUnits: 320,
        genreTags: 'Self-Help',
        coverUrl: 'https://covers.openlibrary.org/b/id/12869622-M.jpg',
        createdAt: now,
        updatedAt: now,
      ),
    ];

    for (final b in initialBooks) {
