            ...
            <CardContent className="space-y-4 pt-0">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <motion.div
                  ...
                  className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-border/80 bg-surface/50 p-4 shadow-xs backdrop-blur-md transition-[border-color,box-shadow] duration-300 hover:border-accent-color/50 hover:shadow-md dark:border-border/80 dark:border-t-amber-100/25 dark:bg-surface/40 dark:shadow-[0_6px_20px_-4px_rgba(0,0,0,0.5)] dark:hover:shadow-[0_16px_40px_-4px_rgba(0,0,0,0.85)]"
                >
