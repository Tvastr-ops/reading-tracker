      ...
      <AnimatePresence mode="popLayout">
        {books.map((b, idx) => {
          ...
          return (
            ...
            >
              <Card
                className={`group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-2xl border border-border/80 border-t-white/30 bg-card-bg/95 backdrop-blur-xl transition-[border-color,box-shadow] duration-300 dark:border-border dark:border-t-amber-100/25 ${idx >= 6 ? 'cv-grid-card' : ''} ${
                  isSelected
